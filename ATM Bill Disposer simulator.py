'''
In this project we'll program the bill dispenser subsystem for an ATM, considering that the customer can request withdraws amounts with dollar-precision and 
the availability of the bills.
...
The bills available are: $500, $100, $50, $25, $10, $5, $1. The availability of each bill will be given in a form of dictionary in our input data for the function.
